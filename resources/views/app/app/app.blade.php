...
<body style="padding: 0; margin: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/logo.png') }}" height="35"
                    alt="SHOES 98" loading="lazy"></a>
    ...
    <footer class="text-center text-lg-start bg-light text-muted">
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2024
                    <a class="text-white" href="/">&ensp;SHOES 98</a>
                </span>
            </div>
        </section>
    </footer>
